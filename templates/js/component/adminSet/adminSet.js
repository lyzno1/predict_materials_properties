export default {
    ...
    <el-table height="calc(100vh - 132px)" stripe border :data="tableData" style="width: 100%"
        ...
        <el-table-column prop="教职工号" label="教职工号"></el-table-column>
        <el-table-column label="操作">
            <template v-slot="scope" style="display: flex; flex-direction: column;">
                <el-button type="primary" plain @click="openChange(scope.row.教职工号)">修改密码</el-button>
    ...
    <el-dialog v-model="updataOne" title="修改">
        <el-form :model="temp">
            <el-form-item label="教职工号">
                <el-input v-model="temp.教职工号" autocomplete="off"></el-input>
            </el-form-item>
        </el-form>
        <template #footer>
            <span class="dialog-footer">
